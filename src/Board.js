...
const Board = ({ reset, setReset, winner, setWinner }) => {
	...
	return (
		...
		<div className="button">
			<button onClick={()=>{setTurn(0)}} className='playerButton'>PLAYER: X</button>
			<button onClick={(e)=>{setTurn(1)}} className='playerButton'>PLAYER: O</button>
			<h3>*Select your character before start</h3>
		</div>
